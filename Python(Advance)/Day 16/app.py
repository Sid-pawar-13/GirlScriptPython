...
model = pickle.load(open(r'D:\GitHub\GirlScriptPython\Python(Advance)\Day16\model.pkl','rb'))
...
def main():
    ...
    <h2 style = "color:white;text-align:center;">Your forest is in danger</h2>
    </div>
    """
